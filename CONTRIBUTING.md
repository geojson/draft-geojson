...
documents](https://datatracker.ietf.org/wg/geojson/documents/) and [mailing
list discussion](https://mailarchive.ietf.org/arch/browse/geojson/). If you're
...
([info](https://www.ietf.org/mailman/listinfo/geojson)). This will ensure that
